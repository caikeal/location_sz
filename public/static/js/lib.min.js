	...
	createNew: function() {
		...
		stepCondition.processEvent = function(event) {
			...
			if (this.isFirstEvent) { // 第一次监测
				...
				if (g && e >= this.energyThreshold && this.stepWindow.getDuration() > 0.33 && this.stepWindow.getDuration() < 2 && this.stepWindow.getPeakValue() - longTermAcc > 0.7 && longTermAcc - this.stepWindow.getValleyValue() > 0.2) {
					let temNow = +new Date();
